...
////here smooker
//static const struct attribute_group sch5636_group = {
//    .attrs = sch5636_attributes,
//};

//static struct attribute *sch5636_attributes_opt[] = {
//    VIN_UNIT_ATTRS(1),          //changeme
//    VIN_UNIT_ATTRS(5),
//    VIN_UNIT_ATTRS(6),
...
//static const struct attribute_group sch5636_group_opt = {
//    .attrs = sch5636_attributes_opt,
//};
...
//	err = sysfs_create_group(&dev->kobj, &sch5636_group);
//	if (err)
//		return err;

//	/* Register chip-specific device attributes */
//	if (data->type == sch5636 || data->type == w83697hf)
...
//				&sensor_dev_attr_in5_max.dev_attr))
    ...
    data->hwmon_dev = hwmon_device_register(&pdev->dev);            //here
...
static SENSOR_DEVICE_ATTR_RW(pwm1, pwm, 0);         //here smooker
...
//    reg = sch5636_read_value(data, W83627THF_REG_PWM_ENABLE[nr]);
//    reg &= ~(0x03 << W83627THF_PWM_ENABLE_SHIFT[nr]);
//    reg |= (val - 1) << W83627THF_PWM_ENABLE_SHIFT[nr];
//    sch5636_write_value(data, W83627THF_REG_PWM_ENABLE[nr], reg);
    mutex_unlock(&data->update_lock);
    return count;
}
